...
#### Backup **creation** needs the same progress feedback as restore  ·  *usability*
...
#### Delete Blocks needs a background worker + progress banner (preview *and* delete)  ·  *usability*
