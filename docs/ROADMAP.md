...
*High impact.* Step 2 of the IOG time-of-use tariff (step 1 — day/night general rates — shipped in 3.1.5). The 4-rate / 6-hour-cap model is **confirmed against Octopus's published material** and is no longer blocked — full design in `docs/iog_6hr_cap_design.md`.
